...
public:
    ...
    template <class U>
    typename traits<U>::result_type operator()(U& v)
    {
    ...
    template <class U>
    typename traits<const U>::result_type operator()(const U& v)
    {
...
struct sequence {
    ...
    template <class U>
    typename traits<const U>::result_type
    operator()(const U& v)
    {
